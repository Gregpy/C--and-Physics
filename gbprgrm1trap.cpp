...
int main()
{
	...
	double a,b,d,s=0;
	std::string in_val;
	std::cout << "Using the Trapezoidal Rule to determine the definite integral of 1+x^2+x^3.\n";
	...
	std::cout << "The signed area under the curve is equal to: " << std::setprecision(9) << s << std::endl;
