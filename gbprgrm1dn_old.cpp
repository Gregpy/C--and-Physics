...
int main() {
	...
	std::cout << "Using the Trapezoidal Rule to determine the definite integral of cos(x^2). The discreization points are determined by the lower limit 'a' and the upper limit 'b' with the formula n=|(b-a)/(2*pi*10^-4/b)+1| (with b removed from the formula if it is set to 0).\n";
